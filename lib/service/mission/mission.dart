...
Future<dynamic> handleGetDataLuckyWinnersByMissionDetail(id, queryParameters) {
  return clientDio(serviceUrlParam: "/missions/$id/lucky-winners", methodParam: "GET", queryParameters: queryParameters);
}

Future<dynamic> handleGetDataPlayersByMissionDetail(id, queryParameters) {
  return clientDio(serviceUrlParam: "/missions/$id/players", methodParam: "GET", queryParameters: queryParameters);
}
