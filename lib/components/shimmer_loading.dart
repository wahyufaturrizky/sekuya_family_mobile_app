...
class MyWidgetShimmerApp extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return MyWidgetShimmer(isLoading: isLoading, child: child);
  }
}
...
class MyWidgetShimmer extends StatefulWidget {
  ...
  @override
  State<MyWidgetShimmer> createState() => _MyWidgetShimmerState();
}

class _MyWidgetShimmerState extends State<MyWidgetShimmer> {
